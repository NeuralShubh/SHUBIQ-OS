...
function renderDashboard(){
  ...
  if(tc){dashCharts.trend=new Chart(tc,{type:'bar',data:{labels:months,datasets:[{label:'Studio',data:sm,backgroundColor:'rgba(54,132,219,0.65)',borderColor:'#3684DB',borderWidth:1,borderRadius:4,barThickness:18,categoryPercentage:0.7,barPercentage:0.9},{label:'Labs',data:lm,backgroundColor:'rgba(245,158,11,0.65)',borderColor:'#F59E0B',borderWidth:1,borderRadius:4,barThickness:18,categoryPercentage:0.7,barPercentage:0.9},{label:'Expenses',data:em,backgroundColor:'rgba(239,68,68,0.4)',borderColor:'#EF4444',borderWidth:1,borderRadius:4,barThickness:18,categoryPercentage:0.7,barPercentage:0.9}]},options:{responsive:true,maintainAspectRatio:false,plugins:{legend:{display:false}},scales:{x:{ticks:{color:'#758BA5',font:{size:10}},grid:{color:'rgba(54,132,219,0.05)'}},y:{ticks:{color:'#758BA5',font:{size:10},callback:v=>sym+(v/1000)+'K'},grid:{color:'rgba(54,132,219,0.05)'}}}}});}
